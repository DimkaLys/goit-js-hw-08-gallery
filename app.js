...
const imagesGalleryRef = document.querySelector('.js-gallery');
...
imagesGalleryRef.insertAdjacentHTML('beforeend', imgSetMarkup);
...
imagesGalleryRef.addEventListener('click', onImagesContainerClick);
